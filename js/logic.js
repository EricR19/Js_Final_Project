...
function arrayStrings() {
    let arrayString = [
        ...
        { animal: "burro", pista: "Es parecido al perro solo que salvaje" },
        { animal: "gallo", pista: "Nos levanta en la mañana" },
        { animal: "delfin", pista: "Es acuatico y son muy inteligentes" },
        { animal: "zorro", pista: "Astucia, inteligencia y agilidad definen a este escurridizo animal. Pertenece a la familia de los cánidos y suelen tener un tamaño pequeño" },
        { animal: "aguila", pista: "Animal emblema de USA" },
        { animal: "avispa", pista: "Pican y el dolor es muy agudo, es prima de la abeja" },
        { animal: "ciervo", pista: "Se les conocen tambien con el nombre de venados" },
        { animal: "raton", pista: "Les gusta el queso y son enemigos del gato" },
        { animal: "buitre", pista: "Son aves carroñeras" },
        { animal: "armadillo", pista: "Son mamiferos y tienen un caparazon en todo su cuerpo" },
        { animal: "ballena", pista: "Es el animal mas grande del planeta" },
        { animal: "bisonte", pista: "los animales terrestres más pesados ​​de América del Norte" },
        { animal: "elefante", pista: "Son animales con orejas enormes y tienen dos colmillos de marfil" },
        { animal: "rinoceronte", pista: "En su nariz tienen un cuerno y son animales muy grandes y pesados" },
    ];
    return arrayString;
}
let random = () => {
